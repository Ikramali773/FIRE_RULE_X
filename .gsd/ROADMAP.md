...
**Deliverable**: A working rule engine that, given structured building data (type, area, floors, occupancy), returns a list of violations with clause references.
**Requirements**: SPEC Goals 1, 2

**Tasks**:
- [ ] Initialize Next.js project with Tailwind CSS
- [ ] Finalize and validate `nbc_rules.json` (IS 2190:2024 fire extinguisher rules for commercial buildings)
- [ ] Build rule engine service (`lib/ruleEngine.ts`) that processes building data against rules
- [ ] Unit test rule engine with known building scenarios
